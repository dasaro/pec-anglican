...
(alter-var-root #'domain-description #(assoc-in % [:cprops 1 :probs] (vec (conj (get-in % [:cprops 1 :probs]) (/ 17 100)))))
(alter-var-root #'domain-description #(assoc-in % [:cprops 1 :outcomes 2] (merge {:engagement "false"} {:taskCorrect "false"} )))
(alter-var-root #'domain-description #(assoc-in % [:cprops 1 :probs] (vec (conj (get-in % [:cprops 1 :probs]) (/ 3 100)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 3 :probs] (vec (conj (get-in % [:cprops 3 :probs]) (/ 7 10)))))
(alter-var-root #'domain-description #(assoc-in % [:cprops 3 :outcomes 1] (merge {:engagement "false"} )))
(alter-var-root #'domain-description #(assoc-in % [:cprops 3 :probs] (vec (conj (get-in % [:cprops 3 :probs]) (/ 3 10)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 4 :probs] (vec (conj (get-in % [:cprops 4 :probs]) (/ 6 10)))))
(alter-var-root #'domain-description #(assoc-in % [:cprops 4 :outcomes 1] (merge {:engagement "false"} {:taskCorrect "false"} )))
(alter-var-root #'domain-description #(assoc-in % [:cprops 4 :probs] (vec (conj (get-in % [:cprops 4 :probs]) (/ 4 10)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 5 :probs] (vec (conj (get-in % [:cprops 5 :probs]) (/ 17 100)))))
(alter-var-root #'domain-description #(assoc-in % [:cprops 5 :outcomes 2] (merge {:engagement "false"} {:taskCorrect "false"} )))
(alter-var-root #'domain-description #(assoc-in % [:cprops 5 :probs] (vec (conj (get-in % [:cprops 5 :probs]) (/ 3 100)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 6 :probs] (vec (conj (get-in % [:cprops 6 :probs]) (/ 6 10)))))
(alter-var-root #'domain-description #(assoc-in % [:cprops 6 :outcomes 1] (merge {:taskCorrect "false"} )))
(alter-var-root #'domain-description #(assoc-in % [:cprops 6 :probs] (vec (conj (get-in % [:cprops 6 :probs]) (/ 3 10)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 7 :probs] (vec (conj (get-in % [:cprops 7 :probs]) (/ 5 10)))))
...
(alter-var-root #'domain-description #(assoc-in % [:cprops 7 :probs] (vec (conj (get-in % [:cprops 7 :probs]) (/ 3 10)))))
